...
import huyang.edu.cn.sequencefile.SequenceFileDirValueIterator;
import huyang.edu.cn.sequencefile.SequenceFileValueIterator;
...
public final class HadoopUtil {
   ...
   * {@link SequenceFileDirValueIterator}
   *
   * @param path The {@link Path} to count
   * @param pt The {@link PathType}
   * @param filter Apply the {@link PathFilter}.  May be null
   * @param conf The Hadoop {@link Configuration}
